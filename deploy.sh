...
echo -e "  ${GREEN}1.${NC} Open ${BLUE}http://$CONFIGURED_IP:3000${NC} in your browser"
echo -e "  ${GREEN}2.${NC} Click the ${BOLD}Login${NC} button"
echo -e "  ${GREEN}3.${NC} Login with username: ${BOLD}admin${NC} password: ${BOLD}admin${NC}"
echo -e "  ${GREEN}4.${NC} ${YELLOW}Change default passwords immediately!${NC}"
echo -e ""
echo -e "${YELLOW}⚠ If you get 'Invalid redirect_uri' or 'Page not found' on login:${NC}"
echo -e "  See troubleshooting steps at the bottom of this output"
echo -e ""
...
echo -e "${YELLOW}${BOLD}  TROUBLESHOOTING: If Login Fails${NC}"
echo -e "${YELLOW}${BOLD}═══════════════════════════════════════════════════════${NC}"
echo -e ""
echo -e "${YELLOW}Problem: 'Invalid redirect_uri' or 'Page not found' when clicking Login${NC}"
echo -e ""
echo -e "${BOLD}Solution:${NC} Fix Keycloak client redirect URIs manually"
echo -e ""
echo -e "  ${GREEN}1.${NC} Open: ${BLUE}http://$CONFIGURED_IP:8080/admin${NC}"
echo -e "     Login: ${BOLD}admin${NC} / ${BOLD}admin_changeme${NC}"
echo -e ""
echo -e "  ${GREEN}2.${NC} Switch to realm '${BOLD}echograph${NC}' (dropdown top-left)"
echo -e ""
echo -e "  ${GREEN}3.${NC} Fix Frontend Client:"
echo -e "     - Go to: ${BOLD}Clients → echograph-frontend → Settings${NC}"
echo -e "     - Valid redirect URIs: ${BLUE}http://$CONFIGURED_IP:3000/*${NC}"
echo -e "     - Valid post logout redirect URIs: ${BLUE}http://$CONFIGURED_IP:3000/*${NC}"
echo -e "     - Web origins: ${BLUE}http://$CONFIGURED_IP:3000${NC}"
echo -e "     - Click ${BOLD}Save${NC}"
echo -e ""
echo -e "  ${GREEN}4.${NC} Fix API Client:"
echo -e "     - Go to: ${BOLD}Clients → echograph-api → Settings${NC}"
echo -e "     - Valid redirect URIs: ${BLUE}http://$CONFIGURED_IP:8000/*${NC}"
echo -e "     - Web origins: ${BLUE}http://$CONFIGURED_IP:8000${NC}"
echo -e "     - Web origins: ${BLUE}http://$CONFIGURED_IP:3000${NC}"
echo -e "     - Click ${BOLD}Save${NC}"
echo -e ""
echo -e "  ${GREEN}5.${NC} Try login again at: ${BLUE}http://$CONFIGURED_IP:3000${NC}"
echo -e "     Use: ${BOLD}admin${NC} / ${BOLD}admin${NC}"
echo -e ""
echo -e "${BLUE}For more help:${NC}"
echo -e "  • Check logs: ${BOLD}docker-compose logs keycloak${NC}"
echo -e "  • Reinitialize Keycloak: ${BOLD}./keycloak/init-keycloak.sh${NC}"
echo -e "  • See: ${BOLD}DEPLOYMENT.md${NC} and ${BOLD}docs/local-development-windows.md${NC}"
echo -e ""
